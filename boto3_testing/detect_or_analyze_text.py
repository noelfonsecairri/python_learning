...
def main():
    roleArn = 'arn:aws:iam::332292479439:role/AmazonServiceTextractRole-noel'   
    bucket = 'noelbeerbucket'
    document = '2019 | John,K | Earthworms offset straw-induced increase of greenhouse gas emission in upland rice production.pdf'
